...
//First screnn handler
@interface BuddyViewController : UIViewController<CLLocationManagerDelegate, UIWebViewDelegate,UITextFieldDelegate,UIGestureRecognizerDelegate,UIPopoverControllerDelegate,UIPopoverPresentationControllerDelegate>
{
